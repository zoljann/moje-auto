...
namespace MojeAuto.Services.Migrations
{
    ...
    [Migration("20250625110347_Migration79")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinancijskiLimit25062025", b =>
                {
                    b.Property<int>("FinancijskiLimit25062025Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FinancijskiLimit25062025");
                });

            modelBuilder.Entity("KategorijaTransakcije25062025", b =>
                {
                    b.Property<int>("KategorijaTransakcije25062025Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TipKategorije")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("KategorijaTransakcije25062025Id");

                    b.ToTable("KategorijaTransakcije25062025");
                });
            ...
            modelBuilder.Entity("MojeAuto.Model.InitialRecommendation", b =>
                {
                    b.Property<int>("InitialRecommendationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("InitialRecommendationId"));

                    b.Property<int>("PartId")
                        .HasColumnType("int");

                    b.HasKey("InitialRecommendationId");

                    b.HasIndex("PartId");

                    b.ToTable("InitialRecommendations");
                });

            modelBuilder.Entity("MojeAuto.Model.PartAvailabilitySubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MojeAuto.Model.PartRecommendation", b =>
                {
                    b.Property<int>("PartId")
                        .HasColumnType("int");

                    b.Property<int>("RecommendedPartId")
                        .HasColumnType("int");

                    b.Property<float>("Score")
                        .HasColumnType("real");

                    b.HasKey("PartId", "RecommendedPartId");

                    b.HasIndex("RecommendedPartId");

                    b.ToTable("PartRecommendations");
                });
            ...
            modelBuilder.Entity("RadniProstor", b =>
                {
                    ...
                    b.ToTable("RadniProstor");
                });

            modelBuilder.Entity("RezervacijaProstora", b =>
                {
                    ...
                    b.ToTable("RezervacijaProstora");
                });

            modelBuilder.Entity("Transakcija25062025", b =>
                {
            ...
            modelBuilder.Entity("MojeAuto.Model.PartRecommendation", b =>
                {
                    ...
                    b.HasOne("Part", "RecommendedPart")
                        .WithMany()
                        .HasForeignKey("RecommendedPartId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Part");

                    b.Navigation("RecommendedPart");
                });
            ...
            modelBuilder.Entity("RezervacijaProstora", b =>
                {
                    b.HasOne("RadniProstor", "RadniProstor")
                        .WithMany()
