        ...
        public static void Seed(MojeAutoContext db)
        {
            ...
            if (!db.Cars.Any())
            {
                db.Cars.AddRange(
                    ...
                    new Car { VIN = "WDBUF70J34A123456", Brand = "Mercedes-Benz", Model = "E klasa", Year = 2004, Fuel = "Benzin", Engine = "1.5", ImageData = LoadImage("SeedImages/f80.jpg") },
                    new Car { VIN = "WAUZZZ8V4FA012345", Brand = "Audi", Model = "A3", Year = 2015, Fuel = "Dizel", Engine = "3.8" },
                    new Car { VIN = "3FAHP0HA2AR123456", Brand = "Ford", Model = "Fusion", Year = 2010, Fuel = "Benzin", Engine = "2.5", ImageData = LoadImage("SeedImages/e46.jpg") },
                    new Car { VIN = "KMHE34L18GA123456", Brand = "Hyundai", Model = "Sonata", Year = 2016, Fuel = "Dizel", Engine = "2.2" },
                    new Car { VIN = "JN1CV6APXAM123456", Brand = "Infiniti", Model = "G37", Year = 2011, Fuel = "Benzin", Engine = "2.0", ImageData = LoadImage("SeedImages/a5.jpg") },
                    new Car { VIN = "JH4CL96866C123456", Brand = "Acura", Model = "TSX", Year = 2006, Fuel = "Benzin", Engine = "4.0" },
                    new Car { VIN = "1FTFW1ET1EK123456", Brand = "Ford", Model = "F-150", Year = 2014, Fuel = "Dizel", Engine = "1.9", ImageData = LoadImage("SeedImages/e46.jpg") },
